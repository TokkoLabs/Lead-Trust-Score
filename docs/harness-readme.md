> README original del template R2D2-Harness, preservado al pivotar el repo al producto Lead Trust Copilot el 2026-05-27.
...
Detalle en [`docs/docker.md`](docker.md).
